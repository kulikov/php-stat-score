...
class ResultHandler implements Observer
{
    ...
    /**
     * –еализаци€ Observer
     * ¬ызываетс€ когда все данные получены
     *
     * @param $champTableData array Ч†большой массив данных о всех играх чемпионата
     */
	public function update($champTableData)
    {
        /**
         * из Ђсырыхї данных билдим объекты нужных типов (Championship, Team, Game)
         * распихиваем их друг в друга в нужной последовательности
         */
        $championship = $this->_buildChampionshipFromArray($champTableData);

        /* передаем управление ProcessingStrategy Ч котора€ в свою очередь знает, что с этими данными дальше надо делать */
